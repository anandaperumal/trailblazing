<?php
	...
	$mail->Username = "trailblazingwine@gmail.com"; // Your Email Address
	$mail->Password = "trailblazing#123"; // Your Password
	$mail->SMTPSecure = 'tls'; // Check Your Server's Connections for TLS or SSL

	$mail->From = "balaji@q2m.in";
	$mail->FromName = $name;
	$mail->AddAddress("balaji@q2m.in");
